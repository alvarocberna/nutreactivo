        ...
        <div className='d-flex flex-column'>
            <div className='m-auto col-10 col-sm-8 col-md-10 col-lg-11 col-xl-8 d-flex flex-column'>
                ...
                <iframe src='https://youtube.com/embed/S88m8J_QO2c' height={400}
                    className='m-auto col-12 col-md-10 col-lg-8 rounded mb-5' alt='Video Pérdida Grasa Corporal aspectos Clave' />
                ...
                <p style={{ textAlign: 'justify' }}>
                    ...
                    sus depósitos de grasa corporal, es necesario que el gasto energético del cuerpo sea
                    ...
                    energía, proceso conocido como lipólisis.
                </p>
                <p style={{ textAlign: 'justify' }}>
                    ...
                    alimentos procesados altos en azúcar como pan blanco o azúcar, incluso si estos aportan la
                ...
                <p style={{ textAlign: 'justify' }}>
                    ...
                    cuerpo está funcionando con menos energía de la habitual, por lo que es fácil sentirse cansados y tener
