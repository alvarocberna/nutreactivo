...
import { faBolt, faFire, faStopwatch } from '@fortawesome/free-solid-svg-icons'
import {
    RecursoPageHeader,
    RecursoVideoEmbed,
    RecursoSection,
        ...
        <div className='w-100 d-flex flex-column py-5'>
            <div className='m-auto d-flex flex-column col-10 col-sm-8 col-md-10 col-lg-11 col-xl-9' style={{ gap: '20px' }}>
                ...
                <RecursoPageHeader
                    ...
                    description='¿Cómo optimizar mi rendimiento en disciplinas de resistencia intermedia?'
                />
                ...
                <RecursoSection icon={faStopwatch} title='Sistema aeróbico'>
                    <p className='mb-0'>
                        Metaboliza el glucógeno (reservas de carbohidratos del cuerpo) y grasa corporal a través de la
                        respiración celular. Si bien este sistema no nos aporta altas cantidades de energía por unidad
                        de tiempo, tiene una duración mucho más extensa que los otros dos mencionados, pudiendo durar
                        varias horas.
                    </p>
                </RecursoSection>
                <RecursoTip>
